...
describe('util', function () {
  ...
  describe('normalizing values', function () {
    ...
    describe('#generateBalanceObject', () => {
      it('returns balance, shortBalance, and label of decimal balances', () => {
        const { balance, shortBalance } = util.generateBalanceObject('1.2345', 2)
        assert.equal(balance, '1.23')
        assert.equal(shortBalance, '1.23')
      })
    })

...
describe('NewAccountModal', function () {
  ...
  it('changes account name to enable save button to click and calls onSave with alias', function () {
  ...
  it('changes account name but key press Enter to call onSave with alias', function () {
    const alias = 'Account Name'
    const accountInput = wrapper.find('.new-account-modal__input')

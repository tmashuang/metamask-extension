...
const bigNumPlus = (a = 0, b = 0) => createOp(a, b, 'plus')
const bigNumTimes = (a = 0, b = 0) => createOp(a, b, 'times')
...
export function getNewXandTimeEstimate ({ xMousePos, chartXStart, chartWidth, gasPrices, estimatedTimes }) {
  ...
  const currentPosValue2 = (gasPrices[gasPrices.length - 1] - gasPrices[0]) * posPercentile + gasPrices[0]
...
export function setSelectedCircle ({
  ...
  while (lowerX === higherX) {
    ...
    console.log('higherX', higherX, '|', lowerX)

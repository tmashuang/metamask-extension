...
describe('TokenInput Component', () => {
  ...
  describe('rendering', () => {
    ...
    it(
      'should render properly with a token value for fiat, but hideConversion is true',
      () => {
        const mockStore = {
          metamask: {
            currentCurrency: 'usd',
  ...
  describe('handling actions', () => {
    ...
    it(
      'should call onChange on input changes with the hex value for ETH',
      () => {
        const mockStore = {
          metamask: {
            currentCurrency: 'usd',
    ...
    it(
      'should call onChange on input changes with the hex value for fiat',
      () => {
        const mockStore = {
          metamask: {
            currentCurrency: 'usd',

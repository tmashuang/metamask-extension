...
describe('ButtonGroup Component', () => {
  ...
  describe('componentDidUpdate', () => {
    it(
      'should set the activeButtonIndex to the updated newActiveButtonIndex',
      () => {
    ...
    it(
      'should not set the activeButtonIndex to an updated newActiveButtonIndex that is not a number',
      () => {
        assert.equal(wrapper.state('activeButtonIndex'), 1)
  ...
  describe('renderButtons', () => {
    ...
    it(
      'should call handleButtonClick and the respective button\'s onClick method when a button is clicked',
      () => {
    ...
    it(
      'should render all child buttons as disabled if props.disabled is true',
      () => {
        const childButtons = wrapper.find('.button-group__button')

...
describe('SendContent Component', () => {
  ...
  describe('render', () => {
    ...
    it(
      'should render a div with a .send-v2__form class as a child of PageContainerContent',
      () => {
    ...
    it(
      'should render the correct row components as grandchildren of the PageContainerContent component',
      () => {
        const PageContainerContentChild = wrapper.find(PageContainerContent).children()
    ...
    it(
      'should not render the SendHexDataRow if props.showHexData is false',
      () => {
  ...
  it(
    'should not render the asset dropdown if token length is 0 ',
    () => {

...
describe('SendRowErrorMessage Component', () => {
  ...
  describe('render', () => {
    ...
    it(
      'should render null if the passed errors do not contain an error of errorType',
      () => {
    ...
    it(
      'should render an error message if the passed errors contain an error of errorType',
      () => {

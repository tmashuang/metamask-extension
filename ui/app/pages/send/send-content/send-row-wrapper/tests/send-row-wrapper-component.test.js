...
describe('SendContent Component', () => {
  ...
  describe('render', () => {
    ...
    it(
      'should render two children of the root div, with send-v2_form label and field classes',
      () => {
    ...
    it(
      'should render the label as a child of the send-v2__form-label',
      () => {
    ...
    it(
      'should render its first child as a child of the send-v2__form-field',
      () => {
    ...
    it(
      'should not render a SendRowErrorMessage if showError is false',
      () => {
    ...
    it(
      'should render a SendRowErrorMessage with and errorType props if showError is true',
      () => {
    ...
    it(
      'should render its second child as a child of the send-v2__form-field, if it has two children',
      () => {
        wrapper = shallow((
          <SendRowWrapper
            errorType="mockErrorType"
    ...
    it(
      'should render its first child as the last child of the send-v2__form-label, if it has two children',
      () => {
        wrapper = shallow((
          <SendRowWrapper
            errorType="mockErrorType"

...
describe('AccountListItem Component', () => {
  ...
  describe('render', () => {
    ...
    it(
      'should call handleClick with the expected props when the root div is clicked',
      () => {
    ...
    it(
      'should render the account address as a checksumAddress if displayAddress is true and name is provided',
      () => {
    ...
    it(
      'should not render the account address as a checksumAddress if displayAddress is false',
      () => {
    ...
    it(
      'should not render the account address as a checksumAddress if name is not provided',
      () => {
    ...
    it(
      'should render a CurrencyDisplay with the correct props if displayBalance is true',
      () => {
    ...
    it(
      'should only render one CurrencyDisplay if showFiat is false',
      () => {
    ...
    it(
      'should not render a CurrencyDisplay if displayBalance is false',
      () => {

...
jest.mock('../../helpers/utils/token-util', () => ({
  calcTokenAmount: stubs.calcTokenAmount
}));
...
const sendUtils = require('../send.utils.js')
...
describe('send utils', () => {
  ...
  describe('calcGasTotal()', () => {
    it(
      'should call multiplyCurrencies with the correct params and return the multiplyCurrencies return',
      () => {
  ...
  describe('isBalanceSufficient()', () => {
    it(
      'should correctly call addCurrencies and return the result of calling conversionGTE',
      () => {
  ...
  describe('isTokenBalanceSufficient()', () => {
    it(
      'should correctly call conversionUtil and return the result of calling conversionGTE',
      () => {
        stubs.conversionGTE.resetHistory()
  ...
  describe('estimateGas', () => {
    ...
    it(
      'should call ethQuery.estimateGas with the expected params',
      async () => {
    ...
    it(
      'should call ethQuery.estimateGas with the expected params when initialGasLimitHex is lower than the upperGasLimit',
      async () => {
    ...
    it(
      'should call ethQuery.estimateGas with a value of 0x0 and the expected data and to if passed a sendToken',
      async () => {
    ...
    it(
      'should call ethQuery.estimateGas without a recipient if the recipient is empty and data passed',
      async () => {
        const data = 'mockData'
        const to = ''
    ...
    it(
      `should return ${SIMPLE_GAS_COST} if ethQuery.getCode does not return '0x'`,
      async () => {
    ...
    it(
      `should return ${SIMPLE_GAS_COST} if not passed a sendToken or truthy to address`,
      async () => {
        assert.equal(baseMockParams.estimateGasMethod.callCount, 0)
    ...
    it(
      `should not return ${SIMPLE_GAS_COST} if passed a sendToken`,
      async () => {
        assert.equal(baseMockParams.estimateGasMethod.callCount, 0)
    ...
    it(
      `should return ${BASE_TOKEN_GAS_COST} if passed a sendToken but no to address`,
      async () => {
    ...
    it(
      `should return the adjusted blockGasLimit if it fails with a 'Transaction execution error.'`,
      async () => {
    ...
    it(
      `should return the adjusted blockGasLimit if it fails with a 'gas required exceeds allowance or always failing transaction.'`,
      async () => {
        const result = await estimateGas(Object.assign({}, baseMockParams, {
  ...
  describe('getToAddressForGasUpdate()', () => {
    it(
      'should return empty string if all params are undefined or null',
      () => {
    ...
    it(
      'should return the first string that is not defined or null in lower case',
      () => {
  ...
  describe('removeLeadingZeroes()', () => {
    ...
    it(
      'should remove leading zeroes from int when user copy/paste',
      () => {
    ...
    it(
      'should remove leading zeroes from float when user copy/paste',
      () => {

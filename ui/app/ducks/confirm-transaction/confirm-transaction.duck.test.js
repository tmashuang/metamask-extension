...
describe('Confirm Transaction Duck', () => {
  describe('State changes', () => {
    ...
    it(
      'should set tokenData when receiving a UPDATE_TOKEN_DATA action',
      () => {
        assert.deepEqual(
          ConfirmTransactionReducer(mockState, {
    ...
    it(
      'should clear tokenData when receiving a CLEAR_TOKEN_DATA action',
      () => {
        assert.deepEqual(
          ConfirmTransactionReducer(mockState, {
    ...
    it(
      'should clear methodData when receiving a CLEAR_METHOD_DATA action',
      () => {
        assert.deepEqual(
          ConfirmTransactionReducer(mockState, {
    ...
    it(
      'should update transaction amounts when receiving an UPDATE_TRANSACTION_AMOUNTS action',
      () => {
        assert.deepEqual(
          ConfirmTransactionReducer(mockState, {
    ...
    it(
      'should update transaction fees when receiving an UPDATE_TRANSACTION_FEES action',
      () => {
        assert.deepEqual(
          ConfirmTransactionReducer(mockState, {
    ...
    it(
      'should update transaction totals when receiving an UPDATE_TRANSACTION_TOTALS action',
      () => {
        assert.deepEqual(
          ConfirmTransactionReducer(mockState, {
    ...
    it(
      'should update tokenProps when receiving an UPDATE_TOKEN_PROPS action',
      () => {
        assert.deepEqual(
          ConfirmTransactionReducer(mockState, {
    ...
    it(
      'should update nonce when receiving an UPDATE_TO_SMART_CONTRACT action',
      () => {
        assert.deepEqual(
          ConfirmTransactionReducer(mockState, {
    ...
    it(
      'should set fetchingData to true when receiving a FETCH_DATA_START action',
      () => {
        assert.deepEqual(
          ConfirmTransactionReducer(mockState, {
    ...
    it(
      'should set fetchingData to false when receiving a FETCH_DATA_END action',
      () => {
        assert.deepEqual(
    ...
    it(
      'should clear confirmTransaction when receiving a FETCH_DATA_END action',
      () => {
  ...
  describe('Thunk actions', () => {
    ...
    it(
      'updates txData and gas on an existing transaction in confirmTransaction',
      () => {
        const mockState = {
          metamask: {
    ...
    it(
      'updates txData and updates gas values in confirmTransaction',
      () => {
        const txData = {
          history: [],
          id: 2603411941761054,

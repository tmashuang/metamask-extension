...
describe('Confirm Transaction utils', () => {
  ...
  describe('hexGreaterThan', () => {
    it(
      'should return true if the first value is greater than the second value',
      () => {
        assert.equal(
    ...
    it(
      'should return false if the first value is less than the second value',
      () => {
        assert.equal(
    ...
    it(
      'should return false if the first value is equal to the second value',
      () => {
        assert.equal(
    ...
    it(
      'should correctly compare prefixed and non-prefixed hex values',
      () => {
        assert.equal(
  ...
  describe('getHexGasTotal', () => {
    it(
      'should multiply the hex gasLimit and hex gasPrice values together',
      () => {
        assert.equal(
  ...
  describe('addEth', () => {
    it(
      'should add two values together rounding to 6 decimal places',
      () => {
        assert.equal(
    ...
    it(
      'should add any number of values together rounding to 6 decimal places',
      () => {
        assert.equal(
  ...
  describe('addFiat', () => {
    it(
      'should add two values together rounding to 2 decimal places',
      () => {
        assert.equal(
    ...
    it(
      'should add any number of values together rounding to 2 decimal places',
      () => {
        assert.equal(

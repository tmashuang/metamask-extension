...
describe('util', () => {
  ...
  describe('#addressSummary', () => {
    ...
    it(
      'should accept arguments for firstseg, lastseg, and keepPrefix',
      () => {
        const address = '0xfdea65c8e26263f6d9a1b5de9555d2931a33b825'
  ...
  describe('isValidDomainName', () => {
    ...
    it(
      'should return false when given a domain with unacceptable ASCII characters',
      () => {
    ...
    it(
      'should return false when given a TLD that starts with a dash',
      () => {
    ...
    it(
      'should return false when given a TLD that ends with a dash',
      () => {
        assert.strictEqual(util.isValidDomainName('foo.bar-'), false)
      }
    )
    ...
    it(
      'should return false when given a domain name with a chunk that starts with a dash',
      () => {
        assert.strictEqual(util.isValidDomainName('-foo.bar'), false)
      }
    )
    ...
    it(
      'should return false when given a domain name with a chunk that ends with a dash',
      () => {
        assert.strictEqual(util.isValidDomainName('foo-.bar'), false)
      }
    )
    ...
    it(
      'should return false when given a domain that starts with a period',
      () => {
        assert.strictEqual(util.isValidDomainName('.bar'), false)
      }
    )
    ...
    it(
      'should return false when given a subdomain that starts with a period',
      () => {
        assert.strictEqual(util.isValidDomainName('.foo.bar'), false)
      }
    )
    ...
    it(
      'should return false when given a domain that ends with a period',
      () => {
        assert.strictEqual(util.isValidDomainName('bar.'), false)
      }
    )
  ...
  describe('#formatBalance', () => {
    ...
    it(
      'should not parse the balance and return value with 2 decimal points with ETH at the end',
      () => {
  ...
  describe('normalizing values', () => {
    describe('#normalizeToWei', () => {
      it(
        'should convert an eth to the appropriate equivalent values',
        () => {
          const valueTable = {
    ...
    describe('#normalizeEthStringToWei', () => {
      ...
      it(
        'should account for overflow numbers gracefully by dropping extra precision.',
        () => {
      ...
      it(
        'should not truncate very exact wei values that do not have extra precision.',
        () => {
    ...
    describe('#normalizeNumberToWei', () => {
      ...
      it(
        'should convert a kwei number to the appropriate equivalent wei',
        () => {
      ...
      it(
        'should convert a ether number to the appropriate equivalent wei',
        () => {
    ...
    describe('#isHex', () => {
      ...
      it(
        'should return false when given a string containing a non letter/number character',
        () => {
      ...
      it(
        'should return true when given a hex string with hex-prefix',
        () => {
    ...
    describe('#getRandomFileName', () => {
      it(
        'should only return a string containing alphanumeric characters',
        () => {
      ...
      // 50 samples
      it(
        'should return a string that is between 6 and 12 characters in length',
        () => {
          for (let i = 0; i < 50; i++) {
            const result = util.getRandomFileName()
  ...
  describe('checkExistingAddresses', () => {
    ...
    it(
      'should return true when a lowercase address matches an uppercase address in the passed list',
      () => {
    ...
    it(
      'should return true when an uppercase address matches a lowercase address in the passed list',
      () => {
    ...
    it(
      'should return true when a lowercase address matches a lowercase address in the passed list',
      () => {
    ...
    it(
      'should return true when an uppercase address matches an uppercase address in the passed list',
      () => {
        assert(util.checkExistingAddresses('Q', tokenList) === true)
      }
    )
    ...
    it(
      'should return false when the passed address is not in the passed list',
      () => {

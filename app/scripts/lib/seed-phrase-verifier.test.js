...
describe('SeedPhraseVerifier', () => {
  describe('verifyAccounts', () => {
    ...
    it(
      'should be able to verify created account (upper case) with seed words',
      async () => {
        const createdAccounts = await primaryKeyring.getAccounts();
        expect(createdAccounts).toHaveLength(1);
    ...
    it(
      'should be able to verify created account (lower case) with seed words',
      async () => {
        const createdAccounts = await primaryKeyring.getAccounts();
        expect(createdAccounts).toHaveLength(1);
    ...
    it(
      'should be able to verify more than one created account with seed words',
      async () => {

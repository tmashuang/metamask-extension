...
describe('migration #48', () => {
  ...
  it(
    'should migrate NetworkController.provider to Rinkeby if the type is "rpc" and the chainId is invalid (1)',
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    'should migrate NetworkController.provider to Rinkeby if the type is "rpc" and the chainId is invalid (2)',
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    'should not migrate NetworkController.provider to Rinkeby if the type is "rpc" and the chainId is valid',
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    'should migrate NetworkController.provider to Rinkeby if the type is "localhost"',
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    'should re-key NetworkController.provider.rpcTarget to rpcUrl if the type is not "rpc" or "localhost"',
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    'should do nothing to NetworkController if affected state does not exist',
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    'should add frequentRpcListDetail item to beginning of list',
    async () => {
      const existingList = [
  ...
  it(
    'should convert hex transaction metamaskNetworkId values to decimal',
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    'should not modify address book if all entries are valid or un-parseable',
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    'should delete localhost key in IncomingTransactionsController',
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    'should not modify IncomingTransactionsController state if affected key is missing',
    async () => {
      const oldStorage = {
        meta: {},
        data: {

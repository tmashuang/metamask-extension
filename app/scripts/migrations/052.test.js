...
describe('migration #52', () => {
  ...
  it(
    `should move ${MAINNET} tokens and hidden tokens to be keyed by ${MAINNET_CHAIN_ID} for each address`,
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    `should move ${RINKEBY} tokens and hidden tokens to be keyed by ${RINKEBY_CHAIN_ID} for each address`,
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    `should move ${KOVAN} tokens and hidden tokens to be keyed by ${KOVAN_CHAIN_ID} for each address`,
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    `should move ${GOERLI} tokens and hidden tokens to be keyed by ${GOERLI_CHAIN_ID} for each address`,
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    `should move ${ROPSTEN} tokens and hidden tokens to be keyed by ${ROPSTEN_CHAIN_ID} for each address`,
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    `should duplicate ${NETWORK_TYPE_RPC} tokens and hidden tokens to all custom networks for each address`,
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    `should overwrite ${NETWORK_TYPE_RPC} tokens with built in networks if chainIds match`,
    async () => {
      const oldStorage = {
        meta: {},
        data: {

...
describe('migration #34', () => {
  ...
  it(
    'should set migratedPrivacyMode & privacyMode if featureFlags.privacyMode was false',
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    'should NOT change any state if migratedPrivacyMode is already set to true',
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    'should NOT change any state if migratedPrivacyMode is already set to false',
    async () => {
      const oldStorage = {
        meta: {},
        data: {
  ...
  it(
    'should NOT change any state if featureFlags.privacyMode is already true',
    async () => {
      const oldStorage = {
        meta: {},
        data: {

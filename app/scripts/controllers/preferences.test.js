...
describe('preferences controller', () => {
  ...
  describe('setAddresses', () => {
    it(
      'should keep a map of addresses to names and addresses in the store',
      () => {
  ...
  describe('removeToken', () => {
    ...
    it(
      'should remove a token from its state on corresponding address',
      async () => {
    ...
    it(
      'should remove a token from its state on corresponding network',
      async () => {
        await preferencesController.addToken('0xa', 'A', 4);
        await preferencesController.addToken('0xb', 'B', 5);
        switchToRinkeby();
  ...
  describe('on setSelectedAddress', () => {
    it(
      'should update tokens from its state on corresponding address',
      async () => {
        preferencesController.setAddresses(['0x7e57e2', '0x7e57e3']);
        await preferencesController.setSelectedAddress('0x7e57e2');
        await preferencesController.addToken('0xa', 'A', 4);

...
describe('CachedBalancesController', () => {
  ...
  describe('_generateBalancesToCache', () => {
    it(
      'should generate updated account balances where the current network was updated',
      () => {
        const controller = new CachedBalancesController({
          accountTracker: {
            store: {
    ...
    it(
      'should generate updated account balances where the a new network was selected',
      () => {
        const controller = new CachedBalancesController({
          accountTracker: {
            store: {
  ...
  describe('_registerUpdates', () => {
    it(
      'should subscribe to the account tracker with the updateCachedBalances method',
      async () => {
